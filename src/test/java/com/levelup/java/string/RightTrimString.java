 ...
 * @see <a href='http://www.leveluplunch.com/java/examples/trim-'></a>
 * 
 */
public class RightTrimString {
	...
	public void trim_trailing_spaces_from_string_guava () {
		...
		String rightTrimmedString = CharMatcher.WHITESPACE.trimTrailingFrom("       Something in the air       ");
	...
	public void trim_trailing_spaces_from_string_apache_commons () {
		...
		String rightTrimmedString = StringUtils.stripEnd("           Learning to fly          ", " ");
	...
	public void trim_trailing_spaces_from_string_spring_with_trimtrailingWhiteSpace () {
		...
		String rightTrimmedString = org.springframework.util.StringUtils.trimTrailingWhitespace("      Don't come around here no more          ");
	...
	public void trim_trailing_spaces_from_string_spring_with_trim_trailing_character () {
		...
		String rightTrimmedString = org.springframework.util.StringUtils.trimTrailingCharacter("      The waiting        ", ' ');
