...
/**
 * This java example will demonstrate determining if
 * the date is within daylight saving while using TemporalQuery.
 * 
 * @author Justin Musgrove
 * @see <a href='http://www.leveluplunch.com/java/examples/daylight-saving-query-java8/'>Daylight saving query</a>
 */
