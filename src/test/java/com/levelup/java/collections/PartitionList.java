...
/**
 * This java example will demonstrate partitioning a list, 
 * or breaking a list into sublists based on specified size.
 * 
 * @author Justin Musgrove
 * @see <a href='http://www.leveluplunch.com/java/examples/partition-list/'>Partition a list</a>
 * 
 */
